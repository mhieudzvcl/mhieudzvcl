...
### About Me
I am a Computer Networks and Data Communications student at **UIT**, passionate about designing and optimizing system infrastructure and software architectures.
- Current Role: **CMC Cloud Fresher** at **CMC Telecom**.
- Currently learning about: **Cloud Computing and Infrastructure**.
...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/Trivy-1F2F3B?style=for-the-badge&logo=aqua&logoColor=white" />
...
|---|---|---|
| **[UIT-Go Cloud Native Microservices](https://github.com/mhieudzvcl/UIT-Go-Cloud-Native-Microservices)** | Implementing a highly scalable Microservices architecture. | `TypeScript`, `Docker` |
| **[DevSecOps Monitoring Platform](https://github.com/mhieudzvcl/NT114.Q21)** | A platform for infrastructure observability, log aggregation, and security scanning. | `Terraform`, `DevSecOps` |
| **[FaaS RL Prewarming (PPO)](https://github.com/mhieudzvcl/faas-rl-prewarming-ppo)** | Optimizing Serverless function cold start times using RL algorithms. | `Python`, `Reinforcement Learning` |
| **[SDN Access Control System](https://github.com/mhieudzvcl/NT541.Q21-Programmable_Network_Technology)** | Implementing Software-Defined Networking (SDN) and dynamic ACL rules. | `Python`, `SDN` |
| **[FitUp Platform](https://github.com/tehn145/FitUp)** | A fitness social network app featuring real-time messaging and AI-based matchmaking. | `Java`, `Firebase` |
